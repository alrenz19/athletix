...
<aside id="sidebar" class="responsive-sidebar w-40 lg:w-56 bg-[#8C2C08] min-h-screen flex flex-col py-4 lg:py-6 fixed md:static md:translate-x-0 transform -translate-x-full transition-transform duration-300 z-50">
  ...
  <nav class="flex flex-col space-y-0.5 lg:space-y-1 w-full px-2 lg:px-3" role="navigation" aria-label="Main navigation">
    ...
    <!-- Dashboard -->
    <div class="relative">
      <a href="{{ route('coach.dashboard.index') }}" class="nav-item flex items-center text-white hover:bg-[#3E1F0A] transition-colors py-2 lg:py-3 px-3 lg:px-4 rounded-lg group">
    ...
    <!-- Manage Athletes -->
    <div class="relative">
      <a href="{{ route('coach.athletes.index') }}" class="nav-item flex items-center text-white hover:bg-[#3E1F0A] transition-colors py-2 lg:py-3 px-3 lg:px-4 rounded-lg group">
        <div class="nav-icon w-5 h-5 lg:w-6 lg:h-6 flex-shrink-0">
          <svg class="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
    ...
    <!-- Manage Attendance -->
    <div class="relative">
      <a href="{{ route('coach.attendance.index') }}" class="nav-item flex items-center text-white hover:bg-[#3E1F0A] transition-colors py-2 lg:py-3 px-3 lg:px-4 rounded-lg group">
        <div class="nav-icon w-5 h-5 lg:w-6 lg:h-6 flex-shrink-0">
          <svg class="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
            <path d="M16 6l2.29 2.29-4.88 4.88-4-4L2 16.59 3.41 18l6-6 4 4 6.3-6.29L22 12V6z"/>
          </svg>
        </div>
        <span class="nav-text ml-3 lg:ml-4 text-xs lg:text-sm font-medium">Manage Attendance</span>
    ...
    <!-- Notifications -->
    <div class="relative">
      <a href="{{ route('coach.notifications.index') }}" class="nav-item flex items-center text-white hover:bg-[#3E1F0A] transition-colors py-2 lg:py-3 px-3 lg:px-4 rounded-lg group">
        <div class="nav-icon w-5 h-5 lg:w-6 lg:h-6 flex-shrink-0">
          <svg class="w-full h-full" fill="currentColor" viewBox="0 0 24 24">
